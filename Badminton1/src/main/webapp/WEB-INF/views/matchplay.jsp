...
<body>
	<div class="topheader">
		<div class="header1">
			<span class="headertitle">Battle Ground</span>
		</div>
	</div>
	<form action="/saveMatchRecord" method="post">
	<div class="container">
		<div class="row row0">
			<input class="col" id="courtNo" type="text" value="Add matchId" name="match_id">
			
			<input class="col" id="player1" type="text" value="Add player 1" name="player_id1">
			
			<input class="col" id="player2" type="text" value="Add player 2" name="player_id2">
		</div>
		<div class="row row1">
		...
		<div class="row row4">
			...
			<input class="col" id="answer1" name="own_sets_p1" readonly="true" > 
			
			<input class="col" id="answer2" name="own_sets_p2" readonly="true">
		</div>
	</div>
