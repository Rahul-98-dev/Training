...
<body>
	...
	<div class="topwrapper">
		...
		<div class="wrap2">
			<h4 class="admin_name">Hi, ${user.getUsername()}</h4>
			<a href="addevent" class="mngBtnAnchorAdmin">Add a Event</a>
		</div>
	</div>
	...
	<div class="container text-center">
		...
		<div class="row">
			<div class="col-sm-4">
				<a href="fixture" class="mngBtnAnchor">Create Drawers/Fixtures</a>
				
				<a href="seeFixtures" class="mngBtnAnchor">See Fixtures</a>
				
			</div>
			<div class="col-sm-4">
				<a href="getallplayers" class="mngBtnAnchor">View All Players</a>
				
				<a href="disqualifyplayer" class="mngBtnAnchor">Disqualify a Player</a>
					
			</div>
			<div class="col-sm-4">
				<a href="matchPlay" class="mngBtnAnchor">Play Match</a>
				
				<a href="getAllMatchRecords" class="mngBtnAnchor">Match Records</a>
