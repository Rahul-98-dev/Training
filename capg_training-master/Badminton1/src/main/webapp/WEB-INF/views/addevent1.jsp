	...
	<form:form method="POST" modelAttribute="event" action="save">
        ...
        <div class="controls">
          <form:input path="date" class="date" />
			...
			<tr>
				<th><form:label path="playerid">PlayerId1</form:label></th>
				<td><form:input path="playerid" size="15" maxlength="15" /></td>
			</tr>
			<tr>
				<th><form:label path="playerid">PlayerId2</form:label></th>
				<td><form:input path="playerid" size="15" maxlength="15" /></td>
			</tr>
			<tr>
